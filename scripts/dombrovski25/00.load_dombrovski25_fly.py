...
RAW_DIR = os.path.join(PROJECT_ROOT, 'local_data', 'raw', 'dombrovski25_fly')
OUT_DIR = os.path.join(PROJECT_ROOT, 'local_data', 'processed', 'dombrovski25_fly')
OUT_FILE = os.path.join(OUT_DIR, 'dombrovski25_fly.h5ad')
